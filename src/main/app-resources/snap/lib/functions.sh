...
function cleanExit ()
{
  ...
  case "${retval}" in
    ...
    ${ERR_NO_URL}) msg="The COSMO-SkyMed product online resource could not be resolved";;
    ${ERR_NO_MASTER}) msg="The COSMO-SkyMed master product could not be retrieved";;
    ${ERR_NO_SLAVE}) msg="The COSMO-SkyMed slave product could not be retrieved";;
...
function main() {
  ...
  ciop-log "INFO" "(1 of ${num_steps}) Resolve COSMO-SkyMed master online resource"
  ...
  ciop-log "INFO" "(4 of ${num_steps}) Retrieve COSMO-SkyMed master product from ${online_resource}"
